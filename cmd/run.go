...
import (
	...
	"github.com/halokid/daprcli/pkg/metadata"
	"github.com/halokid/daprcli/pkg/print"
	runExec "github.com/halokid/daprcli/pkg/runexec"
	"github.com/halokid/daprcli/pkg/runfileconfig"
	"github.com/halokid/daprcli/pkg/standalone"
	daprsyscall "github.com/halokid/daprcli/pkg/syscall"
	"github.com/halokid/daprcli/utils"
)
  ...
  `,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		go func() {
			...
			// TODO: start the `start service` real cmd
